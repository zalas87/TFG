...
def compImplementation(stv_gt, ids, tmax, smax, dt, v0):
	...
	#En caso de que sea numpy o Cython, como stv_gt tiene filas que son completamente 0 hay que eliminarlas para no comernos posteriormente al vehículo con id 0	
	else: 
